<template>
	<div class="page_root">
		<section class="header">
			<div class="logo">
				<img src="@/assets/tron/Withdrawal_slices/7101cb2ba7da2874ae11574f81f49abd992d568a2bd447-A9yRVS.png"
					alt="" />
			</div>
			...
			<span class="limit" v-if="active === 1">{{ $t('daily_withdrawal_limit') }}:
				{{ daily_withdrawal_limit }}</span>
		...
		<section class="form_item" style="z-index: 1">
			<input v-model="money" type="text" :placeholder="$t('please_enter_withdrawal_limit')" />
		</section>

		<section class="form_item" style="z-index: 1">
			<input v-model="address" type="text" :placeholder="$t('please_enter_the_withdrawal_address')" />
		</section>

		<section class="form_item" style="z-index: 1">
			<input v-model="pwd" type="password" :placeholder="$t('please_enter_the_withdrawal_password')" />
		</section>

		<div class="submit" style="z-index: 1" v-if="active !== 3" @click="handleSubmit()">
			<div class="kuai">
				<img src="@/assets/tron/长箭头2@2x.png" alt="" />
			</div>
			{{ $t('confrm') }}
		</div>
		<div class="submit" :class="{ submit_no: gift_status === 0 }" style="z-index: 1" v-if="active === 3"
			@click="giftSubmit()">
			<div class="kuai">
				<img v-if="gift_status === 1" src="@/assets/tron/长箭头2@2x.png" alt="" />
			</div>
			{{ $t('confrm') }}
		</div>
	</div>
