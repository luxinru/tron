	...
	<div class="page_root">
		<section class="header">
			<div class="title">
				...
				<!-- {{ $t('home') }} -->
				<div class="imgs">
					<van-popover v-model="showPopover" trigger="click" placement="bottom-start" :actions="actions"
					...
					<img src="@/assets/tron/Home_slices/组 101 拷贝.png" @click="$router.push('/kefu')" />

					<img class="note" src="@/assets/tron/Home_slices/image-removebg-preview (3).png"
						@click="$router.push('/notice')" />
				</div>
			</div>

			<div class="total">
				<span class="total_title">{{ $t('total_balance') }}
					<img src="@/assets/tron/Home_slices/refresh2.png" @click="tgHistory()" />
				</span>
				<span class="total_value">{{ totalBalance }}<span>TRX</span></span>
				<span class="total_ex">≈ ＄{{ (totalBalance * price_in_usd).toFixed(2) }}</span>
				<img class="img" src="@/assets/tron/Home_slices/image-removebg-preview (1).png" />
			</div>
				...
				<div class="item">
					...
					<div class="info">
						...
						<div class="info_value">
							...
							<span class="value">≈ $ {{ (dataInfo.money * price_in_usd).toFixed(2) }}</span>
						</div>
					</div>
				</div>

				<div class="item">
					<img src="@/assets/tron/Home_slices/a202ce7ef2db5e829264b3ea5e65b2e83978a150189b89-4XYfp5.png" />
					<div class="info">
						<div class="info_title">{{ $t('promotion') }}</div>
						<div class="info_value">
							<span class="value">{{ dataInfo.promotion }}</span>
							<span class="value">≈ $ {{ (dataInfo.promotion * price_in_usd).toFixed(2) }}</span>
						</div>
					</div>
				</div>
			</div>
