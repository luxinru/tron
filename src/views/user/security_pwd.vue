<template>
  <div class="page">
    <div class="main">
      <div class="item">
        <span>{{ $t('old_security_password') }}</span>
        <input
          type="password"
          v-model.trim="passwd"
          :placeholder="$t('old_security_password')"
        />
      </div>
      <div class="item">
        <span>{{ $t('new_security_password') }}</span>
        <input
          type="password"
          v-model.trim="npasswd"
          :placeholder="$t('new_security_password')"
        />
      </div>
      <div class="item">
        <span>{{ $t('confrm_security_password') }}</span>
        <input
          type="password"
          v-model.trim="snpasswd"
          :placeholder="$t('confrm_security_password')"
        />
      </div>
    </div>
